<template>
  <div class="main">    
    <a-form-model class="user-layout-login" @keyup.enter.native="handleSubmit">
      <a-tabs :activeKey="customActiveKey" :tabBarStyle="{ textAlign: 'center', borderBottom: 'set' }"  @change="handleTabClick">
...
export default {
    ...
    methods:{
      ...
      requestSuccess(loginResult){
        console.log("登陆后台成功requestSuccess");
        //获取用户信息
